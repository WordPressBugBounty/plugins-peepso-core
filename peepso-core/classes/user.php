...
class PeepSoUser
{
    ...
    {
        return (is_array($this->peepso_user) && $this->peepso_user['usr_avatar_custom']);
	}
...
//		$this->profile_fields->set('gender', $gender);
    ...
    public static function reset_all_users_notification_preferences()
    {
        ...
        global $wpdb;
        $wpdb->update($wpdb->usermeta, array('meta_value' => maybe_serialize($notifications)), array('meta_key' => 'peepso_notifications'));
    }

    public static function reset_all_users_email_intensity() {
        $intensity = intval(PeepSo::get_option_new('default_email_intensity'));
        global $wpdb;
        $wpdb->update($wpdb->usermeta, array('meta_value' => $intensity), array('meta_key' => 'peepso_email_intensity'));
    }
